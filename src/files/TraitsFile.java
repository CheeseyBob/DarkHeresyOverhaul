...
class TraitsFile implements PrintableFile {
	...
	public void print(DHOPrinter printer) {
		...
		printer.printTableRow_trait(Trait.fast.withParameter("N"));
		printer.printTableRow_trait(Trait.flight.withParameter("N"));
		printer.printTableRow_trait(Trait.hover.withParameter("N"));
		printer.printTableRow_trait(Trait.legs.withParameter("N"));
		printer.printTableRow_note("Characters without this Trait are assumed to have 2 legs.");
		printer.printTableRow_trait(Trait.limbless);
		printer.printTableRow_trait(Trait.machine);
		printer.printTableRow_trait(Trait.size.withParameter("N"));
		printer.printTableRow_note("Characters without this Trait are assumed to be Size 7 (human size).");
		printer.printTableRow_trait(Trait.slow.withParameter("N"));
		printer.printTableRow_trait(Trait.sonarSense.withParameter("N"));
		printer.printTableRow_trait(Trait.unnaturalSenses.withParameter("N"));
		...
		printer.printTableRow_trait(Trait.daemonicPresence.withParameter("N"));
		...
		printer.printTableRow_trait(Trait.armoured.withParameter("N"));
		printer.printTableRow_trait(Trait.burrower.withParameter("N"));
		printer.printTableRow_trait(Trait.fearRating.withParameter("N"));
		...
		printer.printTableRow_trait(Trait.regeneration.withParameter("N"));
