...
class ActionsInDowntimeFile implements PrintableFile {
	...
	private static String[][] actionsTable_basic = {
			...
			{"Reference Forbidden Lore (Research)", "Long", "Basic Skill", "Intelligence", "Get Clues/Info"},
			{"Reference Scholasic Lore (Research)", "Long", "Basic Skill", "Intelligence", "Get Clues/Info"},
