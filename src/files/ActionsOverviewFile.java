...
class ActionsOverviewFile implements PrintableFile {
	...
	public void print(DHOPrinter printer) {
		...
		printer.printSubSubheader("Cover");
		...
		printer.printParagraph("If this results in duplicate Aspects attached to the same thing, they combine into a single upgraded Aspect. Each time an Aspect is upgraded, the bonus it confers increases by +10 (or decreases by -10 in the case of penalites).");
