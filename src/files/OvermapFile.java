...
class OvermapFile implements PrintableFile {
	...
	private static final String[][] encountersTable_middleHive = {
			...
			{"31-37", "Scum (Ld10+1) brawling"},
			{"38-40", "Scum (Ld10+1) knife-fighting"},
			{"41-43", "Petty criminals (Ld10) pickpocketing people on the street"},
			{"44-45", "Petty criminals (Ld10) mugging people in an alleyway"},
