...
class MiscItemsFile implements PrintableFile {
	...
	public void print(DHOPrinter printer) {
		...
		printer.printCol_item(6, Clothing.drabGarb);
		...
		printer.printCol_item(6, Clothing.arbitesUniform);
		printer.printCol_item(6, Clothing.enforcerUniform);
		printer.printCol_item(6, Clothing.militaryUniform);
		printer.printCol_item(6, Clothing.imperialRobes);
		printer.printCol_item(6, Clothing.administratumRobes);
		printer.printCol_item(6, Clothing.astraTelepathicaRobes);
		printer.printCol_item(6, Clothing.chirurgeonRobes);
		printer.printCol_item(6, Clothing.mechanicusRobes);
		printer.printCol_item(6, Clothing.ministorumRobes);
		printer.printCol_item(6, Clothing.fancyClothes);
		printer.printCol_item(6, Clothing.smartClothes);
		printer.printCol_item(6, Clothing.elegantClothes);
		printer.printCol_item(6, Clothing.resplendentClothes);
