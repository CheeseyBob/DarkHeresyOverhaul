...
public class PsychicPower extends SpecialRule {
	...
	public static final PsychicPower telekineticPunch = new PsychicPower("Telekinetic Punch",
			"Main Action; +20 bonus. Target within P+10m becomes Stunned. You can spend 10 Potency to give a -10 penalty to oppose this.",
			"-", 1);
	public static final PsychicPower telekineticShove = new PsychicPower("Telekinetic Shove",
			"Main Action; +20 bonus. Target within 10m becomes Prone and is pushed P meters if they fail to oppose. Every 10 Potency gives a -10 penalty to oppose this. You can spend 1 Potency to increase the range by 1m.",
			"-", 1);
	public static final PsychicPower boltOfForce = new PsychicPower("Bolt of Force",
			"Main Action; +0 bonus. Target within 10m takes a hit dealing P Impact damage. You can spend 1 Potency to increase the range by 1m.",
			"Telekinetic Punch", 2);
	...
	public static final PsychicPower restrain = new PsychicPower("Restrain",
			"Main Action; Sustained; +0 bonus. Target within 10m becomes Grappled by an intangible force with P+20 Strength. You can spend 1 Potency to increase the range by 1m. While the power is sustained, in addition to repeating the effect, you can take Actions and Reactions for the force.",
			"Telekinetic Control", 2);
	public static final PsychicPower telekineDash = new PsychicPower("Telekine Dash",
			"Full Action; Sustained; +0 bonus. Set your bonus movement value to WB, then Move twice. You can spend 10 Potency to increase your bonus movement by WB. While this power is sustained, your bonus movement has no maximum.",
			"-", 2);
	public static final PsychicPower crush = new PsychicPower("Crush",
			"Main Action; -10 penalty. While Restrain is sustained, instead of repeating the effect of Restrain, you can use this power on the target (Restrain stays sustained afterwards). Target within 10m takes P Impact damage, ignoring Armour. You can spend 1 Potency to increase the range by 1m.",
			"Restrain", 4);
